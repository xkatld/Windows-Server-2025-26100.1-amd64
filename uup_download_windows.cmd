@echo off
:: Generated on 2025-11-28 08:47:25 GMT
...
:START_PROCESS
title 26100.1_amd64_zh-cn_serverdatacenter_30da46b4 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=30da46b4-2ff2-4682-a9ae-23b66dd98713&pack=zh-cn&edition=serverdatacenter&aria2=2"
